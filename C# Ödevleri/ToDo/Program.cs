public class Program {
    public static void Main(string[] args) {
        TeamMember t1 = new TeamMember(); //creating team members
        t1.TeamMembers.Add(1, "Fatih Celik"); //adding team members by default
        t1.TeamMembers.Add(2, "Omur Celik");
        t1.TeamMembers.Add(3, "Aytul Celik");
