class Board{
    ...
    public void addCard(Board b1, TeamMember t1) {
        int lineFlag;
        string line;
        do { //invalid id case for line
            lineFlag = 1;
